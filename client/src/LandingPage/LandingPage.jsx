    ...
    return(
        <Layout>
            <h1 ref={ el => ( title = el )} className='home-title'>
                Welcome to Bouncing Wheelz Car Rental App</h1>
            <p ref={ el => ( subtitle = el )} className='subtitle'>Rent your Dream car, drive your way!</p>
            ...
            <p className='slogan'>Choose a car to know more</p>
            <p className='line'/>
            <section className='sorting-section'>
                <CarInforCard src={coupe} alt={"hatchback"} clicked={onSearchtHandler} name={'coupe'} text={'Check our Hatchbacks'} />
